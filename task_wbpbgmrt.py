...
def wbpbgmrt(vis='',
   ...
   """   
   casalog.origin('wbpbgmrt')

   casalog.post('wbpbgmrt is a temporary task, meant for use until a wbpbgmrt option is enabled from within the tclean task.','WARN')
...
#     shutil.rmtree('evlavp.tab')
      ...
      casalog.post('Exception from task wbpbgmrt : ' + str(e), "SEVERE", "task_wbpbgmrt")
      casalog.post('Error in constructing PBs at the specified frequencies. Please check spwlist/chanlist','SEVERE','task_wbpbgmrt')
      return []
   return pblist
